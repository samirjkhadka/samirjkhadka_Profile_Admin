...
export const getAllSkills = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://samirjkhadka-profile-backend.onrender.com/api/v1/skills/getAllSkills",
...
export const addNewSkill = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://samirjkhadka-profile-backend.onrender.com/api/v1/skills/addSkill",
      data,
      {
        withCredentials: true,
...
export const updateSkill = (id, proficiency) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      `https://samirjkhadka-profile-backend.onrender.com/api/v1/skills/updateSkill/${id}`,
      { proficiency },
      {
        withCredentials: true,
...
export const deleteSkill = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://samirjkhadka-profile-backend.onrender.com/api/v1/skills/deleteSkill/${id}`,
      {
        withCredentials: true,
      }
    );
