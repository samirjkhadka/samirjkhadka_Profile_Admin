...
export const getAllTimeline = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://samirjkhadka-profile-backend.onrender.com/api/v1/timeline/getAllTimelines",
...
export const addNewTimeline = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://samirjkhadka-profile-backend.onrender.com/api/v1/timeline/addTimeline",
      data,
      {
        withCredentials: true,
...
export const deleteTimeline = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://samirjkhadka-profile-backend.onrender.com/api/v1/timeline/deleteTimeline/${id}`,
      {
        withCredentials: true,
      }
    );
