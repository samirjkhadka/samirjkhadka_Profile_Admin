...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col sm:gap-4 sm:py-4 sm:pl-14">
      <main className="grid flex-1 items-start gap-4 p-4 sm:px-6sm:py-0 md:gap-8 lg:grid-cols-2 xl:grid-cols-2">
        <div className="grid auto-rows-max items-start gap-4 md:gap-8 lg:col-span-2">
          <div className="grid gap-4 sm:grid-cols-2 mdd:grid-cols-4 lg:grid-cols-2 xl:grid-cols-4">
            ...
            <Card className="flex flex-col justify-center">
              ...
              <CardFooter>
                <Button onClick={gotoMangeProjects}>Manage Skills</Button>
              </CardFooter>
            </Card>
          </div>
          <Tabs>
                          ...
                          return (
                            <TableRow key={element._id} className="bg-accent">
                              ...
                              <TableCell className="text-right">
                                <Link to={element.prrojectLink} target="_blank">
                                  <Button>Visit</Button>
                                </Link>
                              </TableCell>
                            </TableRow>
          ...
          <Tabs>
              ...
              <Card>
                <CardHeader className="px-7 flex items-center justify-between flex-row">
                  ...
                  <Button onClick={gotoMangeTimeline}>Manage Timeline</Button>
                </CardHeader>
                <CardContent>
                  <Table>
                    <TableHeader>
                    ...
                    <TableBody>
                      {timeline && timeline.length > 0 ? (
                        ...
                        <TableRow>
                          <TableCell className="text-3xl overflow-y-hidden">
                            You haven&apos;t added any timeline yet
                          </TableCell>
                        </TableRow>
                      )}
                    </TableBody>
