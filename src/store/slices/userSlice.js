...
export const login = (email, password) => async (dispatch) => {
  ...
  try {
    const { data } = await axios.post(
      "https://samirjkhadka-profile-backend.onrender.com/api/v1/user/login",
      { email, password },
  ...
  (currentPassword, newPassword, confirmNewPassword) => async (dispatch) => {
    ...
    try {
      const { data } = await axios.put(
        "https://samirjkhadka-profile-backend.onrender.com/api/v1/user/password/update",
...
export const updateProfile = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      "https://samirjkhadka-profile-backend.onrender.com/api/v1/user/me/profile/update",
      data,
      {
        withCredentials: true,
